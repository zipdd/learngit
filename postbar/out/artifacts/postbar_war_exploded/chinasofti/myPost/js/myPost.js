...
$(document).ready(function () {
	...
	getPostList(searchNameVal,0,everyPageDataCount,true,"/myPostController/getMyPostList");
	...
	$.ajax({
	    ...
	    success: function (json) {
	    	...
	    	if(json.message!=""){
	    		...
	    		returnPostList();
	    		var searchNameVal=$("#SEARCH_POST_NAME_HIDDEN").val().trim();
	    		getPostList(searchNameVal,postPageIndex,everyPageDataCount,true,"/myPostController/getMyPostList");
...
function GOTO_POST_NEXT_PAGE(){
	...
	var searchNameVal=$("#SEARCH_POST_NAME_HIDDEN").val().trim();
	getPostList(searchNameVal,postPageIndex+1,everyPageDataCount,true,"/myPostController/getMyPostList");
}

function GOTO_POST_TAIL_PAGE(){
	var searchNameVal=$("#SEARCH_POST_NAME_HIDDEN").val().trim();
	getPostList(searchNameVal,postAllPage-1,everyPageDataCount,true,"/myPostController/getMyPostList");
}
...
function GOTO_POST_PAGE(){
	...
	var searchNameVal=$("#SEARCH_POST_NAME_HIDDEN").val().trim();
	getPostList(searchNameVal,jumpVal-1,everyPageDataCount,true,"/myPostController/getMyPostList");
}
